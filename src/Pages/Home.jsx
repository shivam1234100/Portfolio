...
const Home = () => {
    ...
    return (
        <Box>
                ...
                <Flex flexDirection={['column-reverse', 'column-reverse', 'row']} m="auto" justifyContent="space-around" alignItems="center" h="100%">
                    <Box data-aos="fade-down">
                        ...
                        <Box className='content'>
                            <Heading fontSize="3.3em" className='text' data-text="Shivam Tiwari"><span className='themeText'>Shivam Tiwari</span></Heading>
                        </Box>
                        <Text>Am a Software Developer, passionate and experienced in building Web applications.</Text>
                        <HStack className='hireMe' onClick={() => { window.open("https://drive.google.com/file/d/1jBa-w_YRCtrqAD7xrRw20mwkTO6QhH/view", '_blank') }}>
                    ...
                    <Box className='form-section'>
                        ...
                        <Flex className='contact-info'>
                            <HStack>
                                ...
                                <Text>imshivam1408@gmail.com</Text>
                            </HStack>
                            <HStack>
                                <FaPhoneAlt color="#00a14f" />
                                <Text>+91 8808591752</Text>
                            </HStack>
                        </Flex>
                        <Flex gap={["10px", "20px", "20px", "40px"]}>
                            <Link href='https://wa.me/918808591752' target="_blank">
                                <Tooltip label='+91 8808591752'>
                            ...
                            <Link href="https://github.com/shivam1234100" target="_blank">
                                <Tooltip label='Shivam1234100'>
                                    <Box className='social-icons'>
                                        <Box>
                            ...
                            <Link href="mailto:imshivam1408@gmail.com" target="_blank">
                                <Tooltip label='imshivam1408@gmail.com'>
                                    <Box className='social-icons'>
                                        <Box>
            ...
            {/* footer */}
            <Flex id='footer'>
                <Text>© Portfolio by Shivam Tiwari</Text>
                <Text>Made by Shivam</Text>
            </Flex>
        </Box >
    )
}
